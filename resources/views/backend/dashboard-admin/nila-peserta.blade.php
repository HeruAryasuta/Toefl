...
@section('content')
                        ...
                        <div class="col-auto ms-auto d-print-none">
                            <div class="btn-list">
                                <a href="#" class="btn btn-primary d-none d-sm-inline-block" data-bs-toggle="modal"
                                    data-bs-target="#modal-input-nilai">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-list">
                                                    <a href="#" class="btn btn-icon btn-sm btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#modal-edit-nilai-{{ $nilai->id_riwayat }}">
                                                    ...
                                                    <form action="{{ route('nilai-peserta.destroy', $nilai->id_riwayat) }}"
    ...
    @foreach($riwayatNilai as $nilai)
        <div class="modal modal-blur fade" id="modal-edit-nilai-{{ $nilai->id_riwayat }}" tabindex="-1" role="dialog"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
