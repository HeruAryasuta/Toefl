...
@section('content')
  ...
  <div class="page">
    ...
    @endif
      ...
      <h3 class="mb-3">Import Data Pengguna</h3>
...
@endif
        ...
        <div class="btn-group gap-2">
          ...
          data-bs-target="#editModal-{{ $user->id_users }}" title="Edit">
          <i class="fas fa-edit"></i>
          </button>
          <form action="{{ route('data-peserta.destroy', $user->id_users) }}" method="POST"
          class="d-inline">
          @csrf
          @method('DELETE')
      ...
      <div class="empty">
        <div class="empty-img">
        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="84" height="84" viewBox="0 0 24 24"
        ...
        Silahkan tambahkan Pengguna baru atau import data Pengguna untuk memulai.
        </p>
  ...
  <div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="addUserModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form action="{{ route('data-peserta.store') }}" method="POST">
        ...
        <div class="mb-3">
        <label for="fakultas-dropdown" class="form-label">Fakultas</label>
        <select id="fakultas-dropdown" class="form-control @error('fakultas') is-invalid @enderror" name="fakultas"
          required>
        ...
        <div class="mb-3">
        <label for="prodi-dropdown" class="form-label">Program Studi</label>
        <select id="prodi-dropdown" class="form-control @error('prodi') is-invalid @enderror" name="prodi" required>
  ...
  <script>
    ...
    const fakultasDropdown = document.getElementById('fakultas-edit');
    const prodiDropdown = document.getElementById('prodi-edit');
