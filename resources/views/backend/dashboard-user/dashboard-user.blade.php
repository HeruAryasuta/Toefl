                ...
                <div class="card-body d-flex align-items-center p-4">
                  <div class="z-index-1">
                    ...
                    <p class="mb-4" style="color: var(--text-light); font-size: 16px; max-width: 600px;">
                      Selamat datang di dashboard TOEFL Prediction. Di sini Anda dapat melihat jadwal tes, hasil, dan informasi penting lainnya.
                    </p>
                  ...
                  <div class="ms-auto d-none d-md-block">
                    <img src="{{ asset('assets/Welcome-cuate.png') }}" alt="Welcome Image" 
                         class="img-fluid" style="max-width: 240px; z-index: 1; position: relative;">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row mb-4">
            ...
            <div class="col-md-4 mb-3">
              <div class="card stats-card shadow-sm h-100">
                <div class="card-body p-4">
                  <div class="d-flex align-items-center mb-3">
                    <div class="card-icon me-3" style="background-color: rgba(46, 204, 113, 0.1); color: var(--secondary-color);">
            ...
            <div class="col-md-4 mb-3">
              <div class="card stats-card shadow-sm h-100">
                <div class="card-body p-4">
                  <div class="d-flex align-items-center mb-3">
                    <div class="card-icon me-3" style="background-color: rgba(243, 156, 18, 0.1); color: var(--accent-color);">
                    ...
                    <div class="card quick-action-card shadow-sm h-100">
                      <div class="card-body p-3 text-center">
                        <div class="d-flex flex-column align-items-center">
                          <div class="card-icon mb-2" style="background-color: rgba(52, 152, 219, 0.1); color: var(--primary-color);">
                ...
                <div class="col-6 mb-3">
                  <a href="{{ route('jadwal-user') }}" class="text-decoration-none">
                    <div class="card quick-action-card shadow-sm h-100">
                      <div class="card-body p-3 text-center">
                        <div class="d-flex flex-column align-items-center">
                          <div class="card-icon mb-2" style="background-color: rgba(46, 204, 113, 0.1); color: var(--secondary-color);">
                ...
                <div class="col-6 mb-3">
                  <a href="#" class="text-decoration-none">
                    <div class="card quick-action-card shadow-sm h-100">
                      <div class="card-body p-3 text-center">
                        <div class="d-flex flex-column align-items-center">
                          <div class="card-icon mb-2" style="background-color: rgba(243, 156, 18, 0.1); color: var(--accent-color);">
